...
Boilerplate for ReactJS with Redux using ES6

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/vivekmarakana/react-redux-boilerplate.git` or [download the zip](https://github.com/vivekmarakana/react-redux-boilerplate/archive/master.zip)
3. **Make sure you're in the directory you just created.** - `cd react-redux-boilerplate`
...
7. Use path.resolve on all path references in both the dev and prod webpack.config. 
